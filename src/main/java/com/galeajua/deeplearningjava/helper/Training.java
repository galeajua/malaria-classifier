package com.galeajua.deeplearningjava.helper;
...
import com.galeajua.deeplearningjava.model.Models;
...
public final class Training {
    ...
    public static void main(String[] args) throws IOException, TranslateException {
        ...
        ImageFolder dataset = initDataset("src/main/java/com/galeajua/deeplearningjava/cell_images_small");
